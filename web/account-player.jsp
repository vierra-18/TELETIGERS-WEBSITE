...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="css/account-player_style.css" />
    ...
    <body class="inactive">
        <%
            ...
            if (sc.getAttribute("SessionUser") == null) {
        ...
        <section class="main-container">
            <nav role="navigation">
                <div id="menuToggle" data-aos="fade-down" data-aos-delay="800">
                    ...
                    <ul id="menu">
                        <a href="#" ><li>LOGOUT <form id="logout-form" action="${pageContext.request.contextPath}/Logout" method="post">
                        ...
                        <a href="#"
                           ><li>
                                DOWNLOAD DATA
                                <form action="${pageContext.request.contextPath}/ManagerPDF" method="post" id="download-form">
            ...
            <section class="container-1" id="cont1">
                ...
                <div class="sub-container-1">
                    <div class="img-container" data-aos="fade-right" data-aos-delay="600">
                        <img src="css/images/<% out.println(sc.getAttribute("SessionUser")); %>.png" alt="profile-picture" />
                    </div>
                    <fieldset
                        ...
                        <div class="text">
                            <h3><b>Name</b><% out.println(sc.getAttribute("SessionName")); %></h3>
                            <h3><b>ign </b><% out.println(sc.getAttribute("SessionUser")); %></h3>
                            <h3><b>team</b><% out.println(sc.getAttribute("SessionGame")); %></h3>
                            <h3><b>role</b><% out.println(sc.getAttribute("SessionRole"));%></h3>
                        </div>
                    </fieldset>
                </div>
            </section>
